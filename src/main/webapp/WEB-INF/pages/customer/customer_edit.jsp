...
<div class="container-fluid">
    <div class="row-fluid title-bar">
        ...
        <div class="col-xs-2">
            <button type="submit" class="btn btn-success navbar-btn pull-right" onclick="onCreate(CREATE_CUSTOMER)">保存
            </button>
        </div>
    </div>
</div>
    ...
    <div class="panel-group">
        <div class="panel panel-primary">
            ...
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                    <div class="well">
                        <c:if test="${empty customer.projectId}">
                            <div class="form-group">
                                <label class="col-xs-4 control-label">关联</label>

                                <div class="col-xs-8" style="text-align: left">
                                    <a href="/customer/create/project"><img
                        ...
                        <div class="col-xs-8">
                            <select class="form-control" id="stage">
                                <option class="form-control"
                                        value="1" ${customer.discussStageId == 1 ? 'selected' : ''}>未洽谈
                                </option>
                                <option class="form-control"
                                        value="2" ${customer.discussStageId == 2 ? 'selected' : ''}>洽谈中
                                </option>
                                <option class="form-control"
                                        value="3" ${customer.discussStageId == 3 ? 'selected' : ''}>合作期
                                </option>
                                <option class="form-control"
                                        value="4" ${customer.discussStageId == 4 ? 'selected' : ''}>其他
                                </option>
                            </select>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        if (${not empty customer.projectId}) {
            var pInfo = {pid: "${customer.projectId}", name: "${customer.projectName}"};
